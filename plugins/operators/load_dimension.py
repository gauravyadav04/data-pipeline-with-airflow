...
class LoadDimensionOperator(BaseOperator):
    """
    Loads dimension table in Redshift using staging table(s) data
    
    :param redshift_conn_id: Redshift connection ID
    :param table: Target table in Redshift to be loaded
    :param select_sql: SQL query for loading data into target table
    :param append_insert: Loading method used - append-insert or truncate-insert
    :param primary key: Update record(s) in target table if primary key match is 
		found when using append-insert method  		
    """
